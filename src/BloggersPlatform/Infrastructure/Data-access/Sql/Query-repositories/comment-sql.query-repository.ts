...
import { CommentQueryType } from '../../../../Api/Types/bloggers-platform.input-query.types';
import {
  CommentPagesType,
  CommentViewType,
...
export class CommentSqlQueryRepository {
  ...
  async findById(
    ...
    return MapToViewBloggerPlatform.mapComment(result[0]);
  }
  ...
  async findByPostId(
    ...
    const mappedComments: CommentViewType[] =
      MapToViewBloggerPlatform.mapComments(result);
    return {
