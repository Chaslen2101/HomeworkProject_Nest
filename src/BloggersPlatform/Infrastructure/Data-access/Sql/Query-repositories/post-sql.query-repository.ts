...
import { PostQueryType } from '../../../../Api/Types/bloggers-platform.input-query.types';
import {
  PostPagesType,
  PostViewType,
...
export class PostSqlQueryRepository {
  ...
  async findManyPosts(
    ...
    const mappedPosts: PostViewType[] =
      MapToViewBloggerPlatform.mapPosts(result);
    return {
  ...
  async findPostById(
    ...
    return MapToViewBloggerPlatform.mapPost(result[0]);
  }
}
