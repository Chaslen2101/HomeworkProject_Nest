...
export class UserSqlRepository {
  ...
  async findUserByLoginOrEmail(loginOrEmail: string): Promise<User | null> {
    ...
    return TypeormEntityMapper.userToDomainEntity(result);
  }
  ...
  async createNewUser(
    ...
    const userEntity: UserTypeormEntity =
      TypeormEntityMapper.userToTypeormEntity(newUser);
    const EmailConfirmTypeormEntity: EmailConfirmInfoTypeormEntity =
      TypeormEntityMapper.emailConfirmInfoToTypeormEntity(emailConfirmInfo);
  ...
  async findEmailConfirmInfoByCode(
    ...
    return TypeormEntityMapper.emailConfirmInfoToDomainEntity(result);
  }
  ...
  async createPasswordRecoveryInfo(
    ...
    const passwordRecoveryTypeormEntity: PasswordRecoveryInfoTypeormEntity =
      TypeormEntityMapper.passwordRecoveryToTypeormEntity(passwordRecoveryInfo);
  ...
  async findPasswordRecoveryInfoByCode(
    ...
    return TypeormEntityMapper.passwordRecoveryToDomainEntity(result);
  }
